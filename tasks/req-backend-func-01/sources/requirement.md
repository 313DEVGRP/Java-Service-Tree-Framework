# 요구사항 원문 — REQ-BACKEND-FUNC-01

<!-- 엑셀 시트 변경 감지 기준선. 손으로 고치지 말 것. -->
<!-- 출처: 요구사항정의서_엑셀양식_v3_1_3.xlsx / 시트 요구사항정의서 / 2행 -->
...
## 상세 내용
[개요]
Backend 의 엔드포인트 Rest API 목록을 찾아낸다.

[상세 기능 요구사항]
컨트롤러 별로 나열된 API 목록들을 플랫하게 나열한다.
ex) controller class name, rest end point, package name, etc …
...
- MainWorker-SubAgent : backend-expert,frontend-expert
## 요청자
개발팀 이민규
## 수용 여부
수용
